%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Script for computing the constants for implicit time integration schemes
%
% Author    : Dr Chennakesava Kadapa
% Date      : 26-Apr-2020
%
% tis = 2 ---> Backward-Euler scheme
%     = 3 ---> CH-alpha scheme
%     = 4 ---> JHW-alpha or KDP-alpha scheme
%     = 5 ---> Newmar-beta scheme
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function td = timeSteppingParameters_Solid(tis, rho, dt, gamm, beta)
